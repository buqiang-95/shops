...
<body>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" name="k_name" id="firstname" placeholder="请输入名字">
    </div>
  </div>
  <div class="form-group">
    <label for="lastname" class="col-sm-2 control-label">学生性别</label>
    <div class="col-sm-10">
      <input type="text" name="k_sex" id="lastname" placeholder="请输入性别">
    </div>
  </div>
  <div class="form-group">
    <label for="lastname" class="col-sm-2 control-label">学生班级</label>
    <div class="col-sm-10">
      <input type="text"  name="k_banji" id="lastname" placeholder="请输入学生班级">
    </div>
  </div>
  <  <div class="form-group">
